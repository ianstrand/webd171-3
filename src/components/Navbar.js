...
const { name = 'Ian Strand\'s Navbar', link1 = 'Home', link2 = 'Page 2', link3 = 'Page 3', url1 = 'http://localhost:3000/#home', url2 = 'http://localhost:3000/#page2', url3 = 'http://localhost:3000/#page3' } = props;
return (
